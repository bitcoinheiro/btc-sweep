...
**💻 bitcoin_sweeper.html** - Original release with minimal external dependencies for PC use.

**📸 bitcoin_sweeper_QRcode.html** - With added option to import/export data via QR code on PC.

**📱 BTC-Sweep.apk** - Wrapped <a href="https://github.com/bitcoinheiro/btc-sweep/releases" target="_blank">APK release</a> of the QR code version above that works on Android devices. Source assets and instructions to build the app on your own are available at the [APK_Source folder](https://github.com/bitcoinheiro/btc-sweep/tree/main/APK_source) of this repository.
